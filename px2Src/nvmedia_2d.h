 ...
 * Note that for yuv surface type with 16bit depth, only scale and crop are
 ...
 * \param[in] dstRect Destination rectangle. For yuv surface type with 16bit depth,
 * the x0 and y0 of destinationRect have to be 0.
